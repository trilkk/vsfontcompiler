...
function(find_freetype)
  if(MSVC)
    ...
    set(FREETYPE_LIBRARY_DEBUG "freetype262d.lib" PARENT_SCOPE)
    set(FREETYPE_LIBRARY "freetype262.lib" PARENT_SCOPE)
  else()
...
function(find_sdl2)
  if(MSVC)
    ...
    check_link_directory_msvc("SDL2-" "lib/x86")
    set(SDL2_LIBRARY_DEBUG "SDL2" "SDL2main" PARENT_SCOPE)
    set(SDL2_LIBRARY "SDL2" "SDL2main" PARENT_SCOPE)
  else()
    include(FindPkgConfig)
    ...
    elseif(ARGV0)
      message(SEND_ERROR "SDL2 required but not found")
    endif()
...
if(${MSVC})
  ...
  check_include_directory("/usr/include" SYSTEM)
